...
Couple of days after finishing this entry, I discovered **[this video](https://www.youtube.com/watch?v=VRjgNgJms3Q)**, where a 28yo guy —not sure how much is true vs. a parody— follows `ChatGPT` over agreeable conversations. Taking him to run away from home without telling anyone, only eating baby food for the whole timeframe, doing an **energy extraction** ritual to place the energy from a rock into a hat. This is only a over
